...
import gmarques.remotewincontrol.presenter.mouse.mousepad_gestos.CLICK_INTERVAL
import gmarques.remotewincontrol.presenter.mouse.mousepad_gestos.MAX_MOV_PERM
